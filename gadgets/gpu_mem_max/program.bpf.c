...
SEC("uprobe//usr/lib/x86_64-linux-gnu/libcuda.so.1:cuMemAlloc_v2")
...
SEC("uretprobe//usr/lib/x86_64-linux-gnu/libcuda.so.1:cuMemAlloc_v2")
...
SEC("uprobe//usr/lib/x86_64-linux-gnu/libcuda.so.1:cuMemAllocManaged")
...
SEC("uretprobe//usr/lib/x86_64-linux-gnu/libcuda.so.1:cuMemAllocManaged")
...
SEC("uprobe//usr/lib/x86_64-linux-gnu/libcuda.so.1:cuMemFree_v2")
